...
//
// The routes in routes/payments.js know nothing about Stripe, Republic
// Bank EPay, or whatever comes next — they only know this interface.
...
class PaymentProvider {
  /** Short machine name, stored on the order (e.g. 'stripe', 'epay'). */
   ...
   * 'raw'  — signature is computed over the exact bytes (Stripe)
